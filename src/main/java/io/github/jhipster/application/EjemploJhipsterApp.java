...
public class EjemploJhipsterApp {

    private static final Logger log = LoggerFactory.getLogger(EjemploJhipsterApp.class);

    private final Environment env;

    public EjemploJhipsterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes EjemploJhipster.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(EjemploJhipsterApp.class);
